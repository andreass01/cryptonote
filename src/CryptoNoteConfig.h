...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x2e51e8;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(22946744093709551916);
...
const char     CRYPTONOTE_NAME[]                             = "futura";
